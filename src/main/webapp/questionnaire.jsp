...
<%@page import="com.tms.services.front.product.bean.Product"%>
<%@page import="com.tms.services.front.product.ProductService"%>
<%@page
...
<%@page import="com.tms.services.front.news.bean.News"%>
